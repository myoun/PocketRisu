...
export const languageChinese = {
    ...
    "globalNote": "全局备注",
    "autoSuggest": "自动建议",
    "autoSuggestPrompt": "自动建议提示词",
    "useGlobalAutoSuggestPrompt": "使用全局自动建议提示词",
    "globalAutoSuggestPrompt": "全局自动建议提示词",
    "autoSuggestMessageCount": "自动建议参考的最近消息数",
    "autoSuggestCount": "自动建议数量",
    "autoSuggestLanguage": "自动建议语言",
    "followRisuLanguage": "跟随 Risu 语言",
    "customLanguage": "自定义语言",
    "autoSuggestToTranslatedInput": "将自动建议插入翻译输入框",
    "autoSuggestIncludePersona": "在自动建议中包含角色设定",
    "autoSuggestIncludeLorebook": "在自动建议中包含已激活的世界书条目",
    "autoSuggestReferencePrivacy": "启用的角色设定和世界书内容会发送给已配置的辅助模型提供商。",
    "autoSuggestFailed": "自动建议生成失败",
    "autoSuggestFormatMismatch": "模型响应中没有可识别的建议。",
    "tokens": "Tokens",
