...
export const languageEnglish = {
    ...
    autoSuggestPrompt: "Auto Suggest Prompt",
    useGlobalAutoSuggestPrompt: "Use Global Auto Suggest Prompt",
    globalAutoSuggestPrompt: "Global Auto Suggest Prompt",
    autoSuggestMessageCount: "Recent Messages for Auto Suggest",
    autoSuggestCount: "Number of Auto Suggestions",
    autoSuggestLanguage: "Auto Suggest Language",
    followRisuLanguage: "Follow Risu Language",
    customLanguage: "Custom Language",
    autoSuggestToTranslatedInput: "Insert Auto Suggestions into Translation Input",
    autoSuggestIncludePersona: "Include Persona in Auto Suggestions",
    autoSuggestIncludeLorebook: "Include Active Lorebook Entries in Auto Suggestions",
    autoSuggestReferencePrivacy: "Enabled persona and lorebook content is sent to the configured submodel provider.",
    autoSuggestFailed: "Auto suggestion failed",
    autoSuggestFormatMismatch: "The model response did not contain recognizable suggestions.",
    tokens: "Tokens",
    ...
    // External MCP
    mcp: "MCP",
    mcpDesc: "Manage access tokens that external MCP clients can use to connect to PocketRisu.",
    mcpServerEnabled: "MCP server",
    mcpServerEnabledDesc: "Allow external MCP clients to connect to PocketRisu.",
    mcpRequireAuth: "Require authentication",
    mcpRequireAuthDesc: "Require a PocketRisu MCP access token for external requests.",
    mcpDisableAuthConfirm: "Turn off MCP authentication? Anyone who can reach the MCP endpoint will be able to access it without a token.",
    mcpAuthDisabledWarning: "Authentication is off. Any client that can reach the MCP endpoint can make requests without an access token.",
    mcpConfigLoadFailed: "Failed to load MCP configuration",
    mcpConfigSaveFailed: "Failed to save MCP configuration",
    mcpEndpoint: "MCP endpoint",
    mcpEndpointDesc: "Use this URL when configuring a Streamable HTTP MCP client.",
    mcpCopyEndpoint: "Copy MCP endpoint",
    mcpEndpointCopied: "MCP endpoint copied.",
    mcpEndpointCopyFailed: "Could not copy the MCP endpoint.",
    mcpAccessTokens: "Access tokens",
    mcpAccessTokensDesc: "Choose a name, permissions, and expiration for each client.",
    mcpCreateToken: "Create token",
    mcpCreateTokenDesc: "The token will be shown only once after it is created.",
    mcpNoTokens: "No MCP tokens",
    mcpNoTokensDesc: "Create a separate token for each external client.",
    mcpNoActiveTokens: "No active tokens",
    mcpNoActiveTokensDesc: "Turn on Show revoked tokens to view the token history.",
    mcpShowRevokedTokens: "Show revoked tokens",
    mcpTokenCounts: (active: number, expired: number, revoked: number) =>
        `${active} active · ${expired} expired · ${revoked} revoked`,
    mcpTokenName: "Token name",
    mcpTokenNamePlaceholder: "e.g. Claude Desktop",
    mcpTokenNameRequired: "Enter a token name.",
    mcpTokenScopes: "Permissions",
    mcpTokenScopeRequired: "Select at least one permission.",
    mcpScopeRead: "Read",
    mcpScopeReadDesc: "Allow tools that inspect PocketRisu data.",
    mcpScopeWrite: "Write",
    mcpScopeWriteDesc: "Allow tools that change PocketRisu data.",
    mcpScopeAdmin: "Admin",
    mcpScopeAdminDesc: "Allow security-sensitive administration tools and all lower permissions.",
    mcpTokenExpiration: "Expiration",
    mcpExpiry7d: "7 days",
    mcpExpiry30d: "30 days",
    mcpExpiry90d: "90 days",
    mcpExpiry1y: "1 year",
    mcpExpiryCustom: "Custom date and time",
    mcpExpiryNever: "No expiration",
    mcpExpiryCustomDate: "Expires at",
    mcpExpiryNeverWarning: "A token without an expiration remains valid until you revoke it. Use this only for a trusted client.",
    mcpTokenExpiryRequired: "Choose a valid expiration date and time.",
    mcpTokenExpiryPast: "The expiration must be in the future.",
    mcpTokenCreated: "MCP token created",
    mcpTokenCreatedDesc: "Copy this token into the external MCP client's configuration.",
    mcpTokenShownOnce: "This token cannot be viewed again. Copy and store it securely before closing this dialog.",
    mcpCopyToken: "Copy token",
    mcpTokenCopied: "Token copied.",
    mcpTokenCopyFailed: "Could not copy the token. Select it and copy it manually.",
    mcpTokenCreatedAt: "Created",
    mcpTokenExpiresAt: "Expires",
    mcpTokenLastUsed: "Last used",
    mcpTokenNeverUsed: "Never",
    mcpTokenNever: "Never",
    mcpTokenActive: "Active",
    mcpTokenExpired: "Expired",
    mcpTokenRevoked: "Revoked",
    mcpRevokeToken: "Revoke token",
    mcpTokenRevokeConfirm: (name: string) => `Revoke “${name}”? The client will immediately lose access.`,
    mcpTokenRevokedSuccess: "Token revoked.",
    mcpTokenRevokeFailed: "Failed to revoke token",
    ...
    requestStatus: {
        ...
        toolFailed: "Tool failed · {name}",
        toolsUsed: "Tools used · {n}",
        toolsFailed: "Tool failures · {n}",
        toolPartial: "Tool flow ended before a final response",
    },
