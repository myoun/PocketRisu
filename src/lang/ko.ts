...
export const languageKorean = {
  ...
  globalNote: "글로벌 노트",
  autoSuggest: "자동 제안",
  autoSuggestPrompt: "자동 제안 프롬프트",
  useGlobalAutoSuggestPrompt: "전역 자동 제안 프롬프트 사용",
  globalAutoSuggestPrompt: "전역 자동 제안 프롬프트",
  autoSuggestMessageCount: "자동 제안에 참조할 최근 메시지 수",
  autoSuggestCount: "자동 제안 개수",
  autoSuggestLanguage: "자동 제안 언어",
  followRisuLanguage: "리스 언어 설정 따르기",
  customLanguage: "커스텀 언어",
  autoSuggestToTranslatedInput: "자동 제안을 입력 번역으로 삽입",
  autoSuggestIncludePersona: "자동 제안에 페르소나 포함",
  autoSuggestIncludeLorebook: "자동 제안에 활성 로어북 포함",
  autoSuggestReferencePrivacy: "활성화한 페르소나와 로어북 내용은 설정된 보조모델 제공자에게 전송됩니다.",
  autoSuggestFailed: "자동 제안 생성 실패",
  autoSuggestFormatMismatch: "모델 응답에서 자동 제안 형식을 찾지 못했습니다.",
  tokens: "토큰",
  ...
  mcp: "MCP",
  mcpDesc:
    "외부 MCP 클라이언트가 PocketRisu에 연결할 때 사용할 액세스 토큰을 관리합니다.",
  mcpServerEnabled: "MCP 서버",
  mcpServerEnabledDesc: "외부 MCP 클라이언트의 PocketRisu 연결을 허용합니다.",
  mcpRequireAuth: "인증 필요",
  mcpRequireAuthDesc: "외부 요청에 PocketRisu MCP 액세스 토큰을 요구합니다.",
  mcpDisableAuthConfirm:
    "MCP 인증을 끌까요? MCP 엔드포인트에 연결할 수 있는 모든 사용자가 토큰 없이 접근할 수 있습니다.",
  mcpAuthDisabledWarning:
    "인증이 꺼져 있습니다. MCP 엔드포인트에 연결할 수 있는 모든 클라이언트가 액세스 토큰 없이 요청할 수 있습니다.",
  mcpConfigLoadFailed: "MCP 설정을 불러오지 못했습니다",
  mcpConfigSaveFailed: "MCP 설정을 저장하지 못했습니다",
  mcpEndpoint: "MCP 접속 주소",
  mcpEndpointDesc: "Streamable HTTP MCP 클라이언트 설정에 이 주소를 사용하세요.",
  mcpCopyEndpoint: "MCP 접속 주소 복사",
  mcpEndpointCopied: "MCP 접속 주소를 복사했습니다.",
  mcpEndpointCopyFailed: "MCP 접속 주소를 복사하지 못했습니다.",
  mcpAccessTokens: "액세스 토큰",
  mcpAccessTokensDesc: "클라이언트마다 이름, 권한, 만료 시점을 정할 수 있습니다.",
  mcpCreateToken: "토큰 만들기",
  mcpCreateTokenDesc: "생성된 토큰은 발급 직후 한 번만 표시됩니다.",
  mcpNoTokens: "MCP 토큰이 없습니다",
  mcpNoTokensDesc: "외부 클라이언트마다 별도의 토큰을 만들어 사용하세요.",
  mcpNoActiveTokens: "활성 토큰이 없습니다",
  mcpNoActiveTokensDesc: "토큰 기록을 보려면 폐기된 토큰 보기를 켜세요.",
  mcpShowRevokedTokens: "폐기된 토큰 보기",
  mcpTokenCounts: (active: number, expired: number, revoked: number) =>
    `활성 ${active}개 · 만료 ${expired}개 · 폐기 ${revoked}개`,
  mcpTokenName: "토큰 이름",
  mcpTokenNamePlaceholder: "예: Claude Desktop",
  mcpTokenNameRequired: "토큰 이름을 입력하세요.",
  mcpTokenScopes: "권한",
  mcpTokenScopeRequired: "권한을 하나 이상 선택하세요.",
  mcpScopeRead: "읽기",
  mcpScopeReadDesc: "PocketRisu 데이터를 조회하는 도구를 허용합니다.",
  mcpScopeWrite: "쓰기",
  mcpScopeWriteDesc: "PocketRisu 데이터를 변경하는 도구를 허용합니다.",
  mcpScopeAdmin: "관리",
  mcpScopeAdminDesc: "보안 관련 관리 도구와 모든 하위 권한을 허용합니다.",
  mcpTokenExpiration: "만료",
  mcpExpiry7d: "7일",
  mcpExpiry30d: "30일",
  mcpExpiry90d: "90일",
  mcpExpiry1y: "1년",
  mcpExpiryCustom: "날짜와 시간 직접 선택",
  mcpExpiryNever: "만료 없음",
  mcpExpiryCustomDate: "만료 시각",
  mcpExpiryNeverWarning:
    "만료가 없는 토큰은 직접 폐기할 때까지 계속 유효합니다. 신뢰할 수 있는 클라이언트에만 사용하세요.",
  mcpTokenExpiryRequired: "올바른 만료 날짜와 시간을 선택하세요.",
  mcpTokenExpiryPast: "만료 시각은 현재보다 이후여야 합니다.",
  mcpTokenCreated: "MCP 토큰 생성 완료",
  mcpTokenCreatedDesc: "이 토큰을 외부 MCP 클라이언트 설정에 복사하세요.",
  mcpTokenShownOnce:
    "이 토큰은 다시 확인할 수 없습니다. 창을 닫기 전에 복사해서 안전하게 보관하세요.",
  mcpCopyToken: "토큰 복사",
  mcpTokenCopied: "토큰을 복사했습니다.",
  mcpTokenCopyFailed: "토큰을 복사하지 못했습니다. 직접 선택해 복사하세요.",
  mcpTokenCreatedAt: "생성",
  mcpTokenExpiresAt: "만료",
  mcpTokenLastUsed: "최근 사용",
  mcpTokenNeverUsed: "사용 이력 없음",
  mcpTokenNever: "없음",
  mcpTokenActive: "활성",
  mcpTokenExpired: "만료됨",
  mcpTokenRevoked: "폐기됨",
  mcpRevokeToken: "토큰 폐기",
  mcpTokenRevokeConfirm: (name: string) =>
    `“${name}” 토큰을 폐기할까요? 해당 클라이언트의 접근이 즉시 차단됩니다.`,
  mcpTokenRevokedSuccess: "토큰을 폐기했습니다.",
  mcpTokenRevokeFailed: "토큰 폐기 실패",
  mcpTokenLoadFailed: "MCP 토큰을 불러오지 못했습니다",
  mcpTokenCreateFailed: "MCP 토큰 생성 실패",
  mcpRetry: "다시 시도",
  ...
  requestStatus: {
    ...
    cacheHit: "캐시 적중 · {n} 토큰",
    toolRunning: "도구 · {name}",
    toolFailed: "도구 실패 · {name}",
    toolsUsed: "도구 사용 · {n}회",
    toolsFailed: "도구 실패 · {n}회",
    toolPartial: "최종 응답 전에 도구 흐름이 종료됨",
  },
