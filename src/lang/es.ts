...
export const languageSpanish = {
    ...
    "autoSuggestPrompt": "Prompt de sugerencias automáticas",
    "useGlobalAutoSuggestPrompt": "Usar prompt global de sugerencias automáticas",
    "globalAutoSuggestPrompt": "Prompt global de sugerencias automáticas",
    "autoSuggestMessageCount": "Mensajes recientes para sugerencias automáticas",
    "autoSuggestCount": "Número de sugerencias automáticas",
    "autoSuggestLanguage": "Idioma de sugerencias automáticas",
    "followRisuLanguage": "Seguir el idioma de Risu",
    "customLanguage": "Idioma personalizado",
    "autoSuggestToTranslatedInput": "Insertar sugerencias en la entrada de traducción",
    "autoSuggestIncludePersona": "Incluir la persona en las sugerencias automáticas",
    "autoSuggestIncludeLorebook": "Incluir entradas activas del libro de lore en las sugerencias",
    "autoSuggestReferencePrivacy": "El contenido habilitado de la persona y del libro de lore se envía al proveedor del submodelo configurado.",
    "autoSuggestFailed": "Error al generar sugerencias automáticas",
    "autoSuggestFormatMismatch": "La respuesta del modelo no contenía sugerencias reconocibles.",
    "tokens": "Tokens",
