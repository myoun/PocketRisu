...
export const languageVietnamese = {
    ...
    "autoSuggestPrompt": "Lời nhắc đề xuất tự động",
    "useGlobalAutoSuggestPrompt": "Dùng lời nhắc đề xuất tự động toàn cục",
    "globalAutoSuggestPrompt": "Lời nhắc đề xuất tự động toàn cục",
    "autoSuggestMessageCount": "Số tin nhắn gần đây dùng cho đề xuất tự động",
    "autoSuggestCount": "Số lượng đề xuất tự động",
    "autoSuggestLanguage": "Ngôn ngữ đề xuất tự động",
    "followRisuLanguage": "Theo ngôn ngữ Risu",
    "customLanguage": "Ngôn ngữ tùy chỉnh",
    "autoSuggestToTranslatedInput": "Chèn đề xuất vào ô nhập bản dịch",
    "autoSuggestIncludePersona": "Bao gồm persona trong đề xuất tự động",
    "autoSuggestIncludeLorebook": "Bao gồm các mục lorebook đang hoạt động trong đề xuất tự động",
    "autoSuggestReferencePrivacy": "Nội dung persona và lorebook đã bật được gửi đến nhà cung cấp mô hình phụ đã cấu hình.",
    "autoSuggestFailed": "Không thể tạo đề xuất tự động",
    "autoSuggestFormatMismatch": "Phản hồi của mô hình không có đề xuất hợp lệ.",
    "tokens": "Mã thông báo",
